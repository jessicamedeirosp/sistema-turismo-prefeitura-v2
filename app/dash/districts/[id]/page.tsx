...
export default function DistrictFormPage({
  ...
  const fetchDistrict = async () => {
    try {
      ...
      toast.error(error.message || 'Erro ao carregar bairro')
      router.push('/dash/districts')
    } finally {
  ...
  if (loadingData) {
    return <LoadingSpinner message="Carregando bairro..." />
  }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: Centro, Maresias, Juquehy"
            ...
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="active" className="text-sm text-gray-700">
                Bairro ativo (disponível para filtros no site)
              </label>
            </div>
          </div>
        </div>
